...
fn chat_zh_hans() -> Map {
    HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 发送  Shift/Option+Enter 换行  ↑/↓ 光标/历史  鼠标滚轮浏览  拖动右侧滚动条  Cmd+Delete/Ctrl+U 清空当前行  /help 命令"),
...
fn chat_en() -> Map {
    HashMap::from([
        ...
        ("chat.footer.default.following", "Enter send  Shift/Option+Enter newline  ↑/↓ cursor/history  Wheel scroll  Drag scrollbar  Cmd+Delete/Ctrl+U clear line  /help commands"),
...
fn chat_de() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.quit_hint", "Ctrl+C erneut drücken zum Beenden"),
        ...
        ("chat.footer.history_choose", "Wählen Sie eine Konversation zum Wiederherstellen. Scrollen Sie weiter nach unten, um mehr zu laden."),
        ...
        ("chat.footer.default.slash", "↑/↓ wählen  Tab vervollständigen  Enter ausführen  Esc abbrechen"),
        ("chat.footer.default.following", "Enter senden  Shift/Option+Enter neue Zeile  ↑/↓ Cursor/Verlauf  Mausrad scrollt  Scrollbar ziehen  Cmd+Delete/Ctrl+U Zeile leeren  /help Befehle"),
        ...
        ("chat.resume.more_available", "Weiter nach unten scrollen, um mehr zu laden  Enter zum Wiederherstellen  Esc zum Schließen"),
        ("chat.resume.end", "Ende erreicht  Enter zum Wiederherstellen  Esc zum Schließen"),
...
fn chat_fr() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.quit_hint", "Appuyez à nouveau sur Ctrl+C pour quitter"),
        ...
        ("chat.footer.history_choose", "Choisissez une conversation à restaurer. Continuez à faire défiler pour en charger plus."),
        ...
        ("chat.footer.default.slash", "↑/↓ choisir  Tab compléter  Entrée exécuter  Esc annuler"),
        ("chat.footer.default.following", "Entrée envoyer  Shift/Option+Entrée nouvelle ligne  ↑/↓ curseur/historique  Molette défiler  Glisser la barre  Cmd+Suppr/Ctrl+U effacer la ligne  /help commandes"),
        ...
        ("chat.resume.more_available", "Continuez à défiler pour charger plus  Entrée pour restaurer  Esc pour fermer"),
        ("chat.resume.end", "Fin atteinte  Entrée pour restaurer  Esc pour fermer"),
...
fn chat_ja() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.quit_hint", "Ctrl+C をもう一度押して終了"),
        ...
        ("chat.footer.history_choose", "復元する会話を選択してください。下へスクロールするとさらに読み込めます。"),
        ...
        ("chat.footer.default.slash", "↑/↓ 選択  Tab 補完  Enter 実行  Esc キャンセル"),
        ("chat.footer.default.following", "Enter 送信  Shift/Option+Enter 改行  ↑/↓ カーソル/履歴  ホイールでスクロール  右のバーをドラッグ  Cmd+Delete/Ctrl+U 行を消去  /help コマンド"),
        ...
        ("chat.resume.more_available", "下へスクロールするとさらに読み込み  Enter で復元  Esc で閉じる"),
        ("chat.resume.end", "末尾です  Enter で復元  Esc で閉じる"),
...
fn chat_ko() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.quit_hint", "Ctrl+C를 다시 눌러 종료"),
        ...
        ("chat.footer.history_choose", "복원할 대화를 선택하세요. 아래로 스크롤하면 더 불러옵니다."),
        ...
        ("chat.footer.default.slash", "↑/↓ 선택  Tab 완성  Enter 실행  Esc 취소"),
        ("chat.footer.default.following", "Enter 전송  Shift/Option+Enter 줄바꿈  ↑/↓ 커서/기록  휠 스크롤  오른쪽 스크롤바 드래그  Cmd+Delete/Ctrl+U 현재 줄 지우기  /help 명령"),
        ...
        ("chat.resume.more_available", "아래로 스크롤하여 더 불러오기  Enter로 복원  Esc로 닫기"),
        ("chat.resume.end", "끝에 도달했습니다  Enter로 복원  Esc로 닫기"),
...
fn chat_zh_hant() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.quit_hint", "再按一次 Ctrl+C 即可關閉"),
        ...
        ("chat.footer.history_choose", "選擇要恢復的歷史會話。繼續向下可載入更多。"),
        ...
        ("chat.footer.default.slash", "↑/↓ 選擇命令  Tab 補全  Enter 執行  Esc 取消"),
        ("chat.footer.default.following", "Enter 傳送  Shift/Option+Enter 換行  ↑/↓ 游標/歷史  滑鼠滾輪瀏覽  拖曳右側捲動條  Cmd+Delete/Ctrl+U 清除目前這一行  /help 命令"),
        ...
        ("chat.resume.more_available", "繼續向下瀏覽可自動載入更多 · Enter 恢復 · Esc 關閉"),
        ("chat.resume.end", "已到末尾 · Enter 恢復 · Esc 關閉"),
