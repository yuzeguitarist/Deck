...
fn chat_de() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter senden  Ctrl+C zweimal zum Beenden  Maus/↑↓/Bild↑/Bild↓  /help Befehle"),
...
fn chat_fr() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Entrée pour envoyer  Ctrl+C deux fois pour quitter  Souris/↑↓/PgUp/PgDn  /help commandes"),
...
fn chat_ja() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 送信  Ctrl+C を 2 回で終了  マウス/矢印/PgUp/PgDn  /help コマンド"),
...
fn chat_ko() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 전송  Ctrl+C 두 번으로 종료  마우스/화살표/PgUp/PgDn  /help 명령"),
...
fn chat_zh_hant() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 傳送  Ctrl+C 雙擊退出  滑鼠/↑↓/PgUp/PgDn 瀏覽  /help 命令"),
