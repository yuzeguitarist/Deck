...
fn chat_zh_hans() -> Map {
    HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 发送  Shift/Option+Enter 换行  Cmd+Delete 清空当前行  鼠标/↑↓/PgUp/PgDn 浏览  /help 命令"),
...
fn chat_en() -> Map {
    HashMap::from([
        ...
        ("chat.footer.default.following", "Enter send  Shift/Option+Enter newline  Cmd+Delete clear line  Mouse/↑↓/PgUp/PgDn scroll  /help commands"),
...
fn chat_de() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter senden  Shift/Option+Enter neue Zeile  Cmd+Delete Zeile leeren  Maus/↑↓/Bild↑/Bild↓  /help Befehle"),
...
fn chat_fr() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Entrée envoyer  Shift/Option+Entrée nouvelle ligne  Cmd+Suppr effacer la ligne  Souris/↑↓/PgUp/PgDn  /help commandes"),
...
fn chat_ja() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 送信  Shift/Option+Enter 改行  Cmd+Delete 行を消去  マウス/矢印/PgUp/PgDn  /help コマンド"),
...
fn chat_ko() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 전송  Shift/Option+Enter 줄바꿈  Cmd+Delete 현재 줄 지우기  마우스/화살표/PgUp/PgDn  /help 명령"),
...
fn chat_zh_hant() -> Map {
    ...
    map.extend(HashMap::from([
        ...
        ("chat.footer.default.following", "Enter 傳送  Shift/Option+Enter 換行  Cmd+Delete 清除目前這一行  滑鼠/↑↓/PgUp/PgDn 瀏覽  /help 命令"),
